# Drupal on Azure App Service - ACR Managed Identity Deployment
...
ACR_NAME=                        # ACR Name, globally unique, 5 - 50 alphanumeric characters, ie: 'acrdrupaldemo<unique>'
ACR_SKU=Basic                    # ACR SKU {Basic, Classic, Premium, Standard}
